...
namespace c2p2::modules {
    ...
    class Rot8000 : public Module {
    public:
        [[nodiscard]] std::string get_id() const override { return "rot8000"; }
        [[nodiscard]] std::vector<std::string> get_supported_actions() const override {
            return {"encrypt", "decrypt"};
        }

        [[nodiscard]] DataBuffer help_text() const override {
            const std::string help = "ROT8000 Module:\n"
                               "Actions:\n"
                               "  encode: Encode input data using ROT8000.\n"
                               "  decode: Decode ROT8000 input data.\n"
                               "Parameters:\n"
